	...
	try {
		...
		if (isnotAuth) {
			return res
				...
				.json({
					error:
						"Bro, why you sneakin’ into someone else’s ID? 😂 Just log in with your own... it’s not that hard.",
				});
		}
		...
		if (isVisitorIdExisting) {
			return res
				...
				.json({
					error:
						"Bro, your system’s already registered… don’t act brand new. Just use your username and keep it moving.",
				});
		}
